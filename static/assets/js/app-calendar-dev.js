...
document.addEventListener("DOMContentLoaded", function () {
    ...
    if (inlineCalendar) {
        inlineDatePicker = inlineCalendar.flatpickr({
    ...
    submitButton.addEventListener("click", function (e) {
        if (submitButton.classList.contains("btn-add-event")) {
            if (isFormValid) {
                ...
                // - Send Event To Sever
                console.log('Start Create New Event')
                ...
                console.log('End Push Event !');
                calendar.refetchEvents();
                console.log('edn refresh !');
    ...
    inlineDatePicker.config.onChange.push(function (selectedDates) {
        calendar.changeView(
            calendar.view.type,
